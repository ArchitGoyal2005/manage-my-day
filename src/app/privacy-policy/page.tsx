export default function page() {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Managey.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Managey, accessible from{" "}
            <a
              href="https://manage-my-day.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://manage-my-day.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: goelarchit824@gmail.com</li>
      </ul>
    </>
  );
}
